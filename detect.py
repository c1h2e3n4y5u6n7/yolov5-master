...
def run(
        ...
        source=ROOT / 'data/fight',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/fight_1', help='file/dir/URL/glob, 0 for webcam')
